...
begin
  ...
  begin
    ...
    sgScript.Cells[0,i+1]:=IntToStr(i+1);
    flg:=false;
...
var i:integer;
begin
  sgScript.ColCount:=Length(name_col);
  sgScript.DefaultColWidth:=110;
  sgScript.ColWidths[0]:=80;
  sgScript.ColWidths[1]:=90;
  sgScript.ColWidths[2]:=165;
  sgScript.ColWidths[3]:=130;
  sgScript.ColWidths[4]:=130;
  sgScript.ColWidths[5]:=90;
  ...
  FormForScript.Top:=MainForm.Top+95;
  FormForScript.Left:=MainForm.Left+25;
end;
//---------------------------------------------------//
