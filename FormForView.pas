...
begin
  ...
  sgTable.FixedCols:=2;
  sgTable.FixedRows:=2;
  sgTable.Color:=clWindow;
  sgTable.FixedColor:=$00D8E9EC;
  sgTable.DefaultColWidth:=85;
  sgTable.ColWidths[0]:=35;
  col:=2;
  sgTable.DefaultRowHeight:=19;
  sgTable.RowHeights[0]:=sgTable.DefaultRowHeight*2;
  bStep.Height:=sgTable.RowHeights[0];
  for i:=0 to Length(head_str)-1 do for j:=0 to Length(head_str[i])-1 do
  sgTable.Cells[i,j]:=head_str[j,i];
  PRT.number_arc:=0;
  ...
  case Arch[i].pnt of
    1:for j:=0 to Length(ArchBasicSet)-1 do
      ...
      begin
        ...
        sgTable.Cells[col,1]:=units_all_bis[ArchBasicSet[j].units];
        col:=col+1;
  ...
  sgTable.ColCount:=col;
  PRT.size_arc:=PRT.number_arc*4+7;
  sgTable.Width:=1060;
  sgTable.Height:=520;
  row:=2;PRT.count_str:=0;
  bStep.Width:=sgTable.ColWidths[0];
  sgTable.ColWidths[1]:=110;
  sgTable.ScrollBars:=ssBoth;
  Top:=MainForm.Top+95;Left:=MainForm.Left+25;
  Autosize:=true;
...
begin
  ...
  sgTable.ColCount:=6;sgTable.RowCount:=2;
  row:=1;
  sgTable.DefaultRowHeight:=19;
  sgTable.DefaultColWidth:=160;
  sgTable.ColWidths[0]:=35;
  bStep.Height:=sgTable.RowHeights[0];
  bStep.Width:=sgTable.ColWidths[0];
  sgTable.ColWidths[1]:=115;
  sgTable.ColWidths[4]:=215;
  sgTable.ColWidths[5]:=90;
  for i:=0 to Length(str_evt)-1 do sgTable.Cells[i,0]:=str_evt[i];
  AutoSize:=true;
  FormForVariablesView.Top:=MainForm.Top+95;
  FormForVariablesView.Left:=MainForm.Left+25;
  FormForVariablesView.FormStyle:=fsStayOnTop;
  Visible:=true;
end;
//---------------------------------------------------//
...
begin
  ...
  row:=1;
  sgTable.DefaultRowHeight:=19;
  sgTable.DefaultColWidth:=130;
  sgTable.ColWidths[0]:=35;
  bStep.Height:=sgTable.RowHeights[0];
  bStep.Width:=sgTable.ColWidths[0];
  sgTable.ColWidths[1]:=109;
  sgTable.ColWidths[4]:=215;
...
begin
  ...
  sgTable.FixedRows:=1;
  sgTable.ScrollBars:=ssVertical;
  sgTable.ColCount:=Length(str_nst);
  sgTable.RowCount:=2;
  row:=1;
  sgTable.DefaultRowHeight:=19;
  sgTable.DefaultColWidth:=130;
  sgTable.ColWidths[0]:=35;
  sgTable.ColWidths[3]:=321;
  bStep.Height:=sgTable.RowHeights[0];
  bStep.Width:=sgTable.ColWidths[0];
...
begin
  ...
  sgTable.DefaultColWidth:=100;sgTable.Color:=$00D8E9EC;sgTable.Height:=500;
  sgTable.ColWidths[0]:=200;sgTable.FixedCols:=1;sgTable.FixedRows:=1;j:=0;
  sgTable.ScrollBars:=ssVertical;
  ...
  end;AutoSize:=true;Top:=MainForm.Top+95;Left:=MainForm.Left+25;
...
begin
  ...
  sgTable.DefaultColWidth:=100; sgTable.Color:=$00D8E9EC;
  ...
  end;Top:=MainForm.Top+95;Left:=MainForm.Left+25;FormStyle:=fsStayOnTop;Visible:=true;
end;
//---------------------------------------------------//
